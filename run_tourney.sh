...
python3 tournament_server.py --game_list game_list.txt --game_output games --hostname 0.0.0.0 --port 10770 --jail_begin "firejail --quiet --profile=$home/python-custom.profile --whitelist=$home/students/{NAME} $home/anaconda3/bin/python $home/run_ai_jailed.py"
