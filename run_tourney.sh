...
python3 tournament_server.py  --game_list lists/none.txt --game_output static/games/round_01 --game_delay 5 --hostname 0.0.0.0 --port 10770 --jail_begin "firejail --quiet --profile=$home/python-custom.profile --whitelist=$home/students/{NAME} $home/anaconda3/bin/python $home/run_ai_jailed.py"
